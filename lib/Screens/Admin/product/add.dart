...
class _CustomDialoggState extends State<CustomDialogg> {
  ...
  var _selectedValue;
  CollectionReference snapshotcategory =
  ...
  _loadCategories() async {
    var _categoryData = Category();
    var _categoryService = StoreCategory();

    var categories = await _categoryService.loadCategory();

    categories.forEach((category) {
      setState(() {
        _categories.add(DropdownMenuItem(
          child: Text(_categoryData.name),
          value: _categoryData.name,
        ));
      });
    });
  }
